                ...
                <div className="flex items-center justify-center flex-col space-y-20">
                        ...
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="md:w-2/3 p-6 relative">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <span className="bg-gray-700 text-cyan-300 px-3 py-1 rounded-full text-sm font-medium">
                                        NextJS
                                    </span>
                    ...
                    >
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="md:w-2/3 p-6 relative">
                                <div className="absolute top-0 right-0 w-16 h-16 bg-cyan-300 transform rotate-45 translate-x-8 -translate-y-8"></div>
                                <h3 className="text-2xl font-bold mb-2 text-cyan-300">
                                    Project 3
                                </h3>
                                <p className="text-gray-300 mb-4">
                                    Description of Project 3. This project
                                    demonstrates innovative solutions and
